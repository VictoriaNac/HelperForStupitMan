...
func main(){
	...
	//==================================================================================================================
	//5. Функция, возвращающая значение
	package fun 

import(
	"fmt"
)
func sum(a, b int)int {     // второй указатель "int" указывает,что надо вернуть сумму двух чисел для дальнейшего использования
	return a + b            // retern ключевое слов указывающее на то,что мы что то будем возвращать
}
func main(){
	sumAB := sum(10, 20)
	fmt.Println(sumAB)
